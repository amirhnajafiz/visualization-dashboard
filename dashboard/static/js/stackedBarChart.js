function createStackedBar(data) {
  ...
  var x = d3.scaleBand().rangeRound([0, 250]).paddingInner(0.05).align(0.1);
  ...
  genreTotals.sort(function (a, b) {
    return a.total - b.total;
  });

  // Update keys to be sorted according to genreTotals
  keys = genreTotals.map(function (d) {
    return d.key;
  });
  ...
  var tip = d3
    ...
    .html(function (event, d) {
      ...
      return (
        "<strong>Genre:</strong> <span class='details'>" +
        genre +
