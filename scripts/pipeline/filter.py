...
if __name__ == "__main__":
    datasets = [
        ...
        {
            "path": "assets/archives/spotify_music_dataset.csv",
        ...
        {
            "path": "assets/archives/spotify_song_attributes.csv",
        ...
        {
            "path": "assets/archives/mxmh_survey_results.csv",
